document.addEventListener("DOMContentLoaded", () => {
  ...
  function getNewWord() {
    get('https://cors-anywhere.herokuapp.com/http://ec2-54-93-222-115.eu-central-1.compute.amazonaws.com:8080/wordle/get', {player_id: getLocalStorageElement("player_id"), word_length: letters})
    ...
    get('https://api.dictionaryapi.dev/api/v2/entries/en/' + currentWord)
      ...
      .then(response => {
        if (response.title !== "No Definitions Found") {
          get('https://cors-anywhere.herokuapp.com/http://ec2-54-93-222-115.eu-central-1.compute.amazonaws.com:8080/wordle/guess', {
